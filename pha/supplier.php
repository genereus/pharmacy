...
<!-- Dashboard icons -->
      ...
      <hr>  
        <center><div>
        <form method="POST" action="insertsupplier.php" style="height: 297px">
  ID:<br>
  ...
  <br>
  Address:<br>
  <input type="text" name="addresse" requred>
  <br> 
   Medecine:<br>
  <input type="text" name="medecine" requred>
  <br>
  Package:<br>
  <input type="text" name="package" requred><br>
  Arrival Time:<br>
  <input type="time" name="arrivaltime" requred><br><br>
