...
<div id="content">
<div id="header">
<h1><a href="manager.php"><img src="images/hd_logo.jpg"></a> FAMIKAN Management System</h1></div>
<div id="left_column">
<div id="button">
<ul>
<ul>
        ...
        <table border="2" class="auto-style1" style="width: 655px">
      <tr>
      <th>Id</th>
      <th>FIRST NAME</th>
      <th>LAST NAME</th>
    ...
    while($row=$query->fetch(PDO::FETCH_ASSOC)){
      ...
      echo "<td> <a href=\"editmedecine.php? id=$row[id]\">Edit</a></td>";
      echo "<td><a href=\"deletemedecine.php? id=$row[id]\" onClick=\"return confirm('are you sure you want to delete')\" >Delete</a></td>";
      echo "</tr>";
...
<!-- Dashboard icons -->
       ...
       <center><h3>View Medecine<h3></center> 
      <hr>  
        <center><div>
